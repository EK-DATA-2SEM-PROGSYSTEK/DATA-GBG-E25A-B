...
## Aktiviteter
Vi skal arbejde med merge konflikger i git. 
En merge-konflikt opstår typisk når:
- Branchene har et **fælles udgangspunkt** (common ancestor), og
- Der er lavet **forskellige commits** på begge branches **efter de skiltes**, og
- De ændrer **samme del af samme fil** på inkompatible måder.
